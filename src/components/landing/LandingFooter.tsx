...
import { Package, Users, Mail, MapPin, Shield } from 'lucide-react';
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              {/* CAMBIO 4: quitado bloque SENAPI */}
            </div>

            {/* Servicios */}
            <div>
              {/* CAMBIO 5: text-muted-foreground → text-foreground */}
              <h4 className="text-xs font-bold uppercase tracking-widest text-foreground mb-4">Servicios</h4>
            ...
            <div>
              {/* CAMBIO 5: text-muted-foreground → text-foreground */}
              <h4 className="text-xs font-bold uppercase tracking-widest text-foreground mb-4">{t('common.contact')}</h4>
              <ul className="space-y-3">
                {/* CAMBIO 2: correo actualizado */}
                <li className="flex items-start gap-2 text-sm text-foreground/70">
                  <Mail className="h-3.5 w-3.5 text-primary mt-0.5 shrink-0" />
                  <a href="mailto:busesapp55@gmail.com" className="hover:text-primary transition-colors break-all">
                    busesapp55@gmail.com
                  </a>
                </li>
                {/* CAMBIO 3: quitado "Not Phone" */}
                <li className="flex items-start gap-2 text-sm text-foreground/70">
